              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a 
                      href="mailto:contact@mariosavi.com" 
            ...
            <div className="glass-card p-8 rounded-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  />
                  {errors.captcha && (
                    <p className="mt-1 text-red-500 text-sm">{errors.captcha}</p>
                  )}
                </div>
                ...
                <button
                  ...
                  className={cn(
                    "w-full md:w-auto px-8 py-3 bg-gradient-blue text-white rounded-lg flex items-center justify-center transition-all duration-300",
                    isSubmitting
                      ? "opacity-75 cursor-not-allowed"
                      : "hover:shadow-blue-glow transform hover:-translate-y-1"
                  )}
                >
                  {isSubmitting ? (
                    <>
