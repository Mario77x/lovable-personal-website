  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      description: [
        ...
        "Reduced user pain points and manual workload and increased user satisfaction, focusing sharply on UX/UI workflow improvements, architectural redesign (multi-tenancy and miscroservices), performance improvements, and reduction of tech debt.",
        ...
        "Applied Datadog for overall product observability, leading adoption of product data for decision making and success measuring.",
        "Improved communication and reduced frustration with stakeholders across the organization by proactively opening comms channels.",
        "Pioneered use of AI tools such as LLMs and vibe-coding for research and rapid prototyping.",
        "Empowered a Tribe of 3 teams, directly managing 2 Senior PMs, helping move the needle towards a modern product operating model.",
      ],
    },
    {
      title: "Product Owner",
