      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 reveal-on-scroll">
            ...
            <p className="text-gray-300 text-balance">I'm a strategic product leader with extensive experience in driving product excellence and digital transformation. I specialize in helping companies apply industry standards adapted to the specific reality and culture of each product and team.</p>
            
            <p className="text-gray-300 text-balance">Throughout my career, I've successfully led cross-functional teams, managed product lifecycles, and optimized operations to increase revenue, improve team efficiency, and enhance user experiences.</p>
